          ...
          {allPost.map((post) => (
            <div className="card mt-3" key={post._id}>
              ...
              <div className="card-body">
                <h5 className=" text-dark font-family-ibm-plex-sans font-size-14 font-style-normal font-weight-500 line-height-normal d-flex align-items-center">
                  {post.postType}
                </h5>
                <div className="d-flex justify-content-between">
                  <h3 className="text-dark font-family-ibm-plex-sans fs-6 fw-bold font-style-normal font-weight-600 line-height-normal mt-1">
                    {post.postTitle}
                  </h3>
                  <div className="px-2 position-relative">
                    ...
                    {show && (
                      <ul className="menu-dropdown position-absolute shadow py-1rounded ">
                        <li>
                          <a href="">Edit</a>
                        </li>
                        <li>
                ...
                {post.postMessage && (
                  <h5
                    className=" card-text post-message fw-light"
                    style={{ fontSize: "15px" }}
                  >
                    {post.postMessage}
                  </h5>
                ...
                <div className="pt-4 pb-1 d-flex align-items-center justify-content-between">
                  <div className="d-flex align-items-center">
                    ...
                    <div className="ms-2 d-flex flex-column align-items-start justify-content-around py-2">
                      <div className=" fw-bold " style={{ fontSize: "13px" }}>
                        {post.postUserName}
                      </div>
                      <div
                        className="p-0 m-0 d-lg-none"
                        style={{ fontSize: "13px" }}
                      >
                        {post.postView}
                      </div>
                  ...
                  <div className="d-flex align-items-center ">
                    ...
                    <button className="share-btn ms-5 me-2 d-flex align-items-center justify-content-around rounded">
                      <i
                        className="fa-solid fa-share-nodes px-2 "
                        style={{ fontSize: "14px" }}
                      ></i>
